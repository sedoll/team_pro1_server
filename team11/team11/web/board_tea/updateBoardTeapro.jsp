...
<%
    ...
    try {
        ...
        if(cnt > 0) {
            ...
            out.println("<script>location.href='/team11/board_tea/boardTeaList.jsp'</script>");
...
//            response.sendRedirect("updateQuestion.jsp?bno="+bno);
            ...
            out.println("<script>location.href='/team11/board_tea/boardTeaList.jsp'</script>"); //location
        }
